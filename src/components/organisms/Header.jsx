...
const Header = ({ onMenuToggle, showMenuButton }) => {
  ...
  return (
    <header
    className="fixed top-0 left-0 right-0 z-40 bg-white border-b border-gray-200 backdrop-blur-md">
    <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
            {/* Left side */}
            <div className="flex items-center space-x-4">
                {showMenuButton && <Button variant="ghost" size="sm" onClick={onMenuToggle} className="lg:hidden">
            ...
            <div className="flex items-center space-x-4">
                <Button variant="outline" size="sm" onClick={() => navigate("/")}>
                    <ApperIcon name="Home" className="h-4 w-4 mr-2" />Dashboard
                                </Button>
